...
<table border='0' width='550' align='center' bgcolor='#686868' cellspacing='1' cellpadding='0'>
      ...
      <table border='0' cellpadding='0' cellspacing='0' width='100%'>
        <tr>
          <td bgcolor='#f4f4f4' width='8%' height='30'>&nbsp;12333대표자명 <font color='red'><b>*</b></font></td>
     ...
     <table border='0' cellpadding='0' cellspacing='0' width='100%'>
      ...
      <form method="post"    action="../member/ajax/addMember.do"   >
        <table border='0' cellpadding='0' cellspacing='0' width='100%'>
        <tr>
      ...
      <input type="hidden" name="officeNum"  value='${office.officeNum}'  >
      ...
      <table border='0' cellpadding='0' cellspacing='0' width='40%'>
        <tr>
          <td bgcolor='#f4f4f4' width='8%' height='30'   style='text-align: center;'>
          	 <input id="delBtn" type="submit" value="등록"  />
