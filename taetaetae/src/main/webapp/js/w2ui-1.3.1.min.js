...
var w2utils=function() {
	...
	function isTime(val) {
		...
		var max;
		val=val.toUpperCase();
		if(val.indexOf("PM")>=0||val.indexOf("AM")>=0)max=12;
		else max=23;
	...
	function stripTags(html) {
		...
		switch(typeof html) {
			case"number":break;
			case"string":html=$.trim(String(html).replace(/(<([^>]+)>)/gi,""));
			break;
			case"object":for(var a in html)html[a]=this.stripTags(html[a]);
			break
		}
		return html
	}
	function encodeTags(html) {
		...
		switch(typeof html) {
			...
			");break;case"object":for(var a in html)html[a]=this.encodeTags(html[a]);break}return html}function escapeId(id){if(typeof id=="undefined"||id==""||id==null)return"";return String(id).replace(/([;&,\.\+\*\~'`:"\!\^#$%@\[\]\(\)=<>\|\/? {
			}
			\\])/g,"\\$1")
		}
		...
		function transition(div_old,div_new,type,callBack) {
			...
			switch(type) {
				case"slide-left":div_old.style.cssText+="overflow:hidden;"+cross("transform","translate3d(0,0,0)","translate(0,0)");
				...
				,1);
				break;
				case"slide-right":div_old.style.cssText+="overflow:hidden;"+cross("transform","translate3d(0,0,0)","translate(0,0)");
				div_new.style.cssText+="overflow:hidden;"+cross("transform","translate3d(-"+width+"px,0,0)","translate(-"+width+"px,0)");
				$(div_new).show();
				window.setTimeout(function() {
				...
				,1);
				break;
				case"slide-down":div_old.style.cssText+="overflow:hidden;z-index:1;"+cross("transform","translate3d(0,0,0)","translate(0,0)");
				...
				,1);
				break;
				case"slide-up":div_old.style.cssText+="overflow:hidden;"+cross("transform","translate3d(0,0,0)","translate(0,0)");
				...
				,1);
				break;
				case"flip-left":div_old.style.cssText+="overflow:hidden;"+cross("-transform","rotateY(0deg)");
				...
				,1);
				break;
				case"flip-right":div_old.style.cssText+="overflow:hidden;"+cross("transform","rotateY(0deg)");
				div_new.style.cssText+="overflow:hidden;"+cross("transform","rotateY(180deg)");
				$(div_new).show();
				window.setTimeout(function() {
					div_new.style.cssText+=cross("transition",time+"s")+";"+cross("transform","rotateY(0deg)");
				...
				,1);
				break;
				case"flip-down":div_old.style.cssText+="overflow:hidden;"+cross("transform","rotateX(0deg)");
				...
				,1);
				break;
				case"flip-up":div_old.style.cssText+="overflow:hidden;"+cross("transform","rotateX(0deg)");
				div_new.style.cssText+="overflow:hidden;"+cross("transform","rotateX(-180deg)");
				$(div_new).show();
				window.setTimeout(function() {
					div_new.style.cssText+=cross("transition",time+"s")+";"+cross("transform","rotateX(0deg)");
				...
				,1);
				break;
				case"pop-in":div_old.style.cssText+="overflow:hidden;"+cross("transform","translate3d(0,0,0)","translate(0,0)");
				...
				,1);
				break;
				case"pop-out":div_old.style.cssText+="overflow:hidden;"+cross("transform","translate3d(0,0,0)","translate(0,0)")+";"+cross("transform","scale(1)")+";opacity:1;";
				...
				,1);
				break;
				default:div_old.style.cssText+="overflow:hidden;"+cross("transform","translate3d(0,0,0)","translate(0,0)");
				div_new.style.cssText+="overflow:hidden;"+cross("transform","translate3d(0,0,0)","translate(0,0)")+";opacity:0;";
				$(div_new).show();
				window.setTimeout(function() {
					div_new.style.cssText+=cross("transition",time+"s")+";opacity:1;";
			...
			setTimeout(function() {
				...
				if(div_new) {
					$(div_new).css( {
						opacity:"1","-webkit-transition":"","-moz-transition":"","-ms-transition":"","-o-transition":"","-webkit-transform":"","-moz-transform":"","-ms-transform":"","-o-transform":"","-webkit-backface-visibility":"","-moz-backface-visibility":"","-ms-backface-visibility":"","-o-backface-visibility":""
					}
					)
				}
				if(div_old) {
					...
					if(div_old.parentNode)$(div_old.parentNode).css( {
						"-webkit-perspective":"","-moz-perspective":"","-ms-perspective":"","-o-perspective":""
					}
					)
				}
		...
		function lock(box,msg,showSpinner) {
			...
			setTimeout(function() {
				...
				setTimeout(function() {
					...
					lock.css( {
						opacity:lock.data("old_opacity"),left:"0px",top:"0px",width:"100%",height:"100%"
					}
					);
					if(!msg)mess.css( {
					...
					mess.html(msg).css( {
						opacity:mess.data("old_opacity"),left:left+"px",top:top+"px"
					}
					)
				}
				,10)
		...
		function getSize(el,type) {
			var bwidth= {
				left:parseInt($(el).css("border-left-width"))||0,right:parseInt($(el).css("border-right-width"))||0,top:parseInt($(el).css("border-top-width"))||0,bottom:parseInt($(el).css("border-bottom-width"))||0
			}
			;
			var mwidth= {
				left:parseInt($(el).css("margin-left"))||0,right:parseInt($(el).css("margin-right"))||0,top:parseInt($(el).css("margin-top"))||0,bottom:parseInt($(el).css("margin-bottom"))||0
			}
			;
			var pwidth= {
				left:parseInt($(el).css("padding-left"))||0,right:parseInt($(el).css("padding-right"))||0,top:parseInt($(el).css("padding-top"))||0,bottom:parseInt($(el).css("padding-bottom"))||0
			}
			;
			switch(type) {
		...
		function lang(phrase) {
			...
			if(typeof translation=="undefined")return phrase;
		...
		function locale(locale) {
			...
			$.ajax( {
				url:locale,type:"GET",dataType:"JSON",async:false,cache:false,success:function(data,status,xhr) {
	...
	w2utils.event= {
		on:function(eventData,handler) {
			...
			;
			eventData=$.extend( {
				type:null,execute:"before",target:null,onComplete:null
			}
			,eventData);
			...
			this.handlers.push( {
				event:eventData,handler:handler
			}
			)
		}
		...
		,trigger:function(eventData) {
			var eventData=$.extend( {
				type:null,phase:"before",target:null,isStopped:false,isCancelled:false
			}
			,eventData, {
			...
			for(var h=this.handlers.length-1;
			h>=0;
			h--) {
	...
	(function() {
				...
				if(text==""||text==null||typeof text=="undefined") {
					...
					var timer=setInterval(function() {
						...
						if($("#w2ui-tag-"+tagID).data("position")!=$(el).offset().left+el.offsetWidth+"x"+$(el).offset().top) {
							$("#w2ui-tag-"+tagID).css( {
								"-webkit-transition":".2s","-moz-transition":".2s","-ms-transition":".2s","-o-transition":".2s",left:$(el).offset().left+el.offsetWidth+"px",top:$(el).offset().top+"px"
							}
					...
					setTimeout(function() {
						if(!$(el).offset())return;
						$("#w2ui-tag-"+tagID).css( {
							opacity:"1",left:$(el).offset().left+el.offsetWidth+"px",top:$(el).offset().top+"px"
						}
		...
		$.fn.w2overlay=function(html,options) {
			...
			div.css( {
				display:"none",left:$(obj).offset().left+options.left+"px",top:$(obj).offset().top+w2utils.getSize($(obj),"height")+3+options.top+"px","min-width":options.width?options.width:"auto","min-height":options.height?options.height:"auto"
			}
			).fadeIn("fast").data("position",$(obj).offset().left+"x"+($(obj).offset().top+obj.offsetHeight)).on("click",function(event) {
			...
			function fixSize() {
				...
				if($("#w2ui-overlay>div").length>0) {
					...
					if(h>max)$("#w2ui-overlay>div").height(max).width(w+w2utils.scrollBarSize()).css( {
						"overflow-y":"auto"
					}
					);
					w=$("#w2ui-overlay>div").width();
					max=window.innerWidth-$("#w2ui-overlay>div").offset().left-7;
					if(w>max)$("#w2ui-overlay>div").width(max).css( {
						"overflow-x":"auto"
					}
					);
					if(typeof options.onShow=="function")options.onShow()
			...
			function getMenuHTML() {
				...
				f++) {
					...
					if(typeof mitem=="string") {
						var tmp=mitem.split("|");
						mitem= {
							id:tmp[0],text:tmp[0],img:null,icon:null
						}
						;
	...
	(function() {
		var w2grid=function(options) {
			...
			this.onDestroy=null;
			this.last= {
				field:"all",caption:w2utils.lang("All Fields"),logic:"OR",search:"",searchIds:[],multi:false,scrollTop:0,scrollLeft:0,selected:[],sortData:null,sortCount:0,xhr:null,range_start:null,range_end:null,sel_ind:null,sel_col:null,sel_type:null
			}
			;
		...
		$.fn.w2grid=function(method) {
			if(typeof method==="object"||!method) {
				...
				$.extend(object, {
					...
					,records:[],columns:[],searches:[],toolbar: {
					}
					,sortData:[],searchData:[],handlers:[]
				}
				);
				if(object.onExpand!=null)object.show.expandColumn=true;
				$.extend(true,object.toolbar,toolbar);
				for(var p in columns)object.columns[p]=$.extend(true, {
				}
				,columns[p]);
				for(var p in columnGroups)object.columnGroups[p]=$.extend(true, {
				}
				,columnGroups[p]);
				for(var p in searches)object.searches[p]=$.extend(true, {
				}
				,searches[p]);
				for(var p in searchData)object.searchData[p]=$.extend(true, {
				}
				,searchData[p]);
				for(var p in sortData)object.sortData[p]=$.extend(true, {
				}
				,sortData[p]);
				object.postData=$.extend(true, {
				}
				,postData);
				...
				for(var c in object.columns) {
					...
					object.addSearch( {
						field:col.field,caption:col.caption,type:stype,attr:attr
					}
					)
				}
				object.initToolbar();
		...
		;
		w2grid.prototype= {
			msgDelete:"Are you sure you want to delete selected records?",msgNotJSON:"Returned data is not in valid JSON format.",msgRefresh:"Refreshing...",buttons: {
				reload: {
					type:"button",id:"reload",img:"icon-reload",hint:"Reload data in the list"
				}
				,columns: {
					type:"drop",id:"column-on-off",img:"icon-columns",hint:"Show/hide columns",arrow:false,html:""
				}
				,search: {
					type:"html",id:"search",html:'<div class="w2ui-icon icon-search-down w2ui-search-down" title="'+"Select Search Field"+'" '+"onclick=\"var obj = w2ui[$(this).parents('div.w2ui-grid').attr('name')];
					obj.searchShowFields(this);
					\"></div>"
				}
				,"search-go": {
					type:"check",id:"search-advanced",caption:"Search...",hint:"Open Search Fields"
				}
				,add: {
					type:"button",id:"add",caption:"Add New",hint:"Add new record",img:"icon-add"
				}
				,edit: {
					type:"button",id:"edit",caption:"Edit",hint:"Edit selected record",img:"icon-edit",disabled:true
				}
				,"delete": {
					type:"button",id:"delete",caption:"Delete",hint:"Delete selected records",img:"icon-delete",disabled:true
				}
				,save: {
					type:"button",id:"save",caption:"Save",hint:"Save changed records",img:"icon-save"
				}
			}
			,add:function(record) {
			...
			,remove:function() {
				...
				a<arguments.length;
				a++) {
					for(var r=this.records.length-1;
					r>=0;
					r--) {
			...
			,removeColumn:function() {
				...
				a<arguments.length;
				a++) {
					for(var r=this.columns.length-1;
					r>=0;
					r--) {
			...
			,removeSearch:function() {
				...
				a<arguments.length;
				a++) {
					for(var r=this.searches.length-1;
					r>=0;
					r--) {
					...
					for(var r in this.records) {
						...
						for(var s in this.searchData) {
							...
							if(search==null)search= {
								field:sdata.field,type:sdata.type
							}
							;
							...
							switch(sdata.operator) {
								case"is":if(rec[search.field]==sdata.value)fl++;
								if(search.type=="date") {
								...
								break;
								case"between":if(search.type=="int"&&parseInt(rec[search.field])>=parseInt(val2)&&parseInt(rec[search.field])<=parseInt(val3))fl++;
								...
								break;
								case"in":if(sdata.value.indexOf(val1)!==-1)fl++;
								break;
								case"begins with":if(val1.indexOf(val2)==0)fl++;
								break;
								case"contains":if(val1.indexOf(val2)>=0)fl++;
								break;
								case"ends with":if(val1.indexOf(val2)==val1.length-val2.length)fl++;
								break
							}
						}
				...
				if(col1==col2) {
					...
					r++) {
						...
						if(extra!==true) {
							...
							res.push( {
								data:dt,column:col1,index:r,record:record
							}
							)
						}
					}
					...
					i++) {
						...
						if(extra!==true) {
							...
							res.push( {
								data:dt,column:i,index:rec1,record:record
							}
							)
						}
					}
						...
						i++) {
							...
							if(extra!==true) {
								...
								res[res.length-1].push( {
									data:dt,column:i,index:r,record:record
								}
								)
							}
						}
			...
			,removeRange:function() {
				...
				a++) {
					...
					for(var r=this.ranges.length-1;
					r>=0;
					r--) {
			...
			,refreshRanges:function() {
				...
				for(var r in this.ranges) {
					...
					if(td1.length>0&&td2.length>0) {
						$("#grid_"+this.name+"_"+rg.name).css( {
							left:td1.position().left-1+rec.scrollLeft()+"px",top:td1.position().top-1+rec.scrollTop()+"px",width:td2.position().left-td1.position().left+td2.width()+3+"px",height:td2.position().top-td1.position().top+td2.height()+3+"px"
						}
						)
					}
				}
				...
				var eventData= {
					phase:"before",type:"selectionExtend",target:obj.name,originalRange:null,newRange:null
				}
				;
				function mouseStart(event) {
					var sel=obj.getSelection();
					obj.last.move= {
						type:"expand",x:event.screenX,y:event.screenY,divX:0,divY:0,recid:sel[0].recid,column:sel[0].column,originalRange:[ {
				...
				function mouseMove(event) {
					...
					eventData=obj.trigger($.extend(eventData, {
						originalRange:mv.originalRange,newRange:mv.newRange
					}
					));
					if(eventData.isCancelled===true) {
						...
						obj.addRange( {
							name:"grid-selection-expand",range:eventData.newRange,style:"background-color:rgba(100,100,100,0.1);border:2px dotted rgba(100,100,100,0.5);"
						}
						)
					}
				}
				...
				a++) {
					...
					if(this.selectType=="row") {
						...
						var eventData=this.trigger( {
							phase:"before",type:"select",target:this.name,recid:recid
						}
						);
						...
						var eventData=this.trigger( {
							phase:"before",type:"select",target:this.name,recid:recid,column:col
						}
						);
						if(eventData.isCancelled===true)continue;
			...
			,unselect:function() {
				...
				a++) {
					...
					if(this.selectType=="row") {
						if(record.selected!==true)continue;
						var eventData=this.trigger( {
							phase:"before",type:"unselect",target:this.name,recid:recid
						}
						);
						if(eventData.isCancelled===true)continue;
						...
						if(!$.isArray(s)||s.indexOf(col)==-1)continue;
						var eventData=this.trigger( {
							phase:"before",type:"unselect",target:this.name,recid:recid,column:col
						}
						);
						if(eventData.isCancelled===true)continue;
			...
			,selectAll:function() {
				...
				var eventData=this.trigger( {
					phase:"before",type:"select",target:this.name,all:true
				}
				);
				...
				if(!url) {
					if(this.searchData.length==0) {
						...
						if(this.selectType=="row") {
							...
							this.set( {
								selected:true,selectedColumns:cols.slice()
							}
							)
						}
					}
				...
				var sel=this.getSelection();
				if(sel.length==1)this.toolbar.enable("edit");
				else this.toolbar.disable("edit");
				if(sel.length>=1)this.toolbar.enable("delete");
				else this.toolbar.disable("delete");
				this.addRange("selection");
				this.trigger($.extend(eventData, {
					phase:"after"
				}
			...
			,selectNone:function() {
				var eventData=this.trigger( {
					phase:"before",type:"unselect",target:this.name,all:true
				}
				);
				if(eventData.isCancelled===true)return;
				this.last.selected=[];
				...
				if(this.selectType=="row") {
					...
					for(var s in sel) {
						...
						for(var c in rec.selectedColumns) {
							ret.push( {
								recid:rec.recid,index:parseInt(sel[s]),column:rec.selectedColumns[c]
							}
							)
						}
					}
			...
			,search:function(field,value) {
				...
				if(arguments.length==0) {
					...
					for(var s in this.searches) {
						...
						if(value1!=""&&value1!=null||typeof value2!="undefined"&&value2!="") {
							var tmp= {
								field:search.field,type:search.type,operator:operator
							}
							;
							if(operator=="between") {
								$.extend(tmp, {
					...
					if(typeof value!="undefined") {
						if(field.toLowerCase()=="all") {
							if(this.searches.length>0) {
								for(var s in this.searches) {
									...
									if(search.type=="text"||search.type=="int"&&w2utils.isInt(value)||search.type=="float"&&w2utils.isFloat(value)||search.type=="money"&&w2utils.isMoney(value)||search.type=="hex"&&w2utils.isHex(value)||search.type=="date"&&w2utils.isDate(value)||search.type=="alphaNumeric"&&w2utils.isAlphaNumeric(value)) {
										var tmp= {
											field:search.field,type:search.type,operator:search.type=="text"?"contains":"is",value:value
										}
										;
										searchData.push(tmp)
									}
									if(search.type=="int"&&String(value).indexOf("-")!=-1) {
										...
										var tmp= {
											field:search.field,type:search.type,operator:"between",value:[t[0],t[1]]
										}
										;
										searchData.push(tmp)
									}
								...
								for(var c in this.columns) {
									var tmp= {
										field:this.columns[c].field,type:"text",operator:"contains",value:value
									}
									;
									searchData.push(tmp)
								}
							...
							if(value!="") {
								...
								var tmp= {
									field:search.field,type:search.type,operator:op,value:val
								}
								;
								searchData.push(tmp)
							}
				...
				if($.isArray(field)) {
					...
					for(var f in field) {
						...
						if(search==null)search= {
							type:"text",operator:"contains"
						}
						;
						searchData.push($.extend(true, {
						}
						,search,data))
					}
				}
				var eventData=this.trigger( {
					phase:"before",type:"search",target:this.name,searchData:searchData,searchField:field?field:"multi",searchValue:value?value:"multi"
				}
				);
				if(eventData.isCancelled===true)return;
			...
			,searchOpen:function() {
				...
				var obj=this;
				$("#tb_"+this.name+"_toolbar_item_search-advanced").w2overlay(this.getSearchesHTML(), {
					left:-10,"class":"w2ui-grid-searches",onShow:function() {
			...
			,searchShowFields:function(el) {
				...
				for(var s=-1;
				s<this.searches.length;
				s++) {
					var search=this.searches[s];
					if(s==-1) {
						if(!this.multiSearch)continue;
						search= {
							type:"text",field:"all",caption:w2utils.lang("All Fields")
						}
					}
					else {
						if(this.searches[s].hidden===true)continue
					}
					html+="<tr "+"	"+(this.isIOS?"onTouchStart":"onClick")+"=\"var obj = w2ui['"+this.name+"'];
				...
				switch(s.type) {
					case"alphaNumeric":case"text":html+='<input rel="search" type="text" size="40" id="grid_'+this.name+"_field_"+i+'" name="'+s.field+'" '+s.inTag+">";
					break;
					case"int":case"float":case"hex":case"money":case"date":html+='<input rel="search" type="text" size="12" id="grid_'+this.name+"_field_"+i+'" name="'+s.field+'" '+s.inTag+">"+'<span id="grid_'+this.name+"_range_"+i+'" style="display:none">'+'&nbsp;-&nbsp;&nbsp;<input rel="search" type="text" size="12" id="grid_'+this.name+"_field2_"+i+'" name="'+s.field+'" '+s.inTag+">"+"</span>";
					break;
					case"list":html+='<select rel="search" id="grid_'+this.name+"_field_"+i+'" name="'+s.field+'" '+s.inTag+"></select>";
					break
				}
				html+=s.outTag+"	</td>"+"</tr>"
			}
			...
			function getGroups() {
				...
				i++) {
					...
					if(colg.master===true) {
						...
						html+='<td class="w2ui-head '+sortStyle+'" col="'+ii+'" rowspan="2" colspan="'+(colg.span+(i==obj.columnGroups.length-1?1:0))+'" '+(col.sortable?"onclick=\"w2ui['"+obj.name+"'].columnClick('"+col.field+"',event);
